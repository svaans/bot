...
class StrategyEngine:
    ...
    def _procesar_resultado_entrada(
        ...
        noticias_ok = True
        # Solo se consulta la fuente de noticias si el filtro está activo. Antes
        # se pedía en CADA evaluación solo para loguear el score, aunque el
        # filtro estuviese desactivado: peticiones de red inútiles que, con la
        # fuente caída (403), spameaban el log en bucle.
