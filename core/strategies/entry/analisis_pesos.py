...
def calcular_pesos_desde_backtest(csv_path="ordenes_simuladas_con_resultado.csv", output_json="estrategias_pesos_backtest.json"):
    ...
    # Estructura: { symbol: { estrategia: stats } }
    resultados_por_symbol = defaultdict(lambda: defaultdict(lambda: {"usos": 0, "ganadoras": 0, "ganancia_total": 0}))
    ...
    # Calcular pesos por símbolo y estrategia
    pesos_por_symbol = {}
