...
def main() -> None:
    ...
    parser.add_argument("--symbols", nargs="+", default=["BTC/EUR", "ETH/EUR", "ADA/EUR", "SOL/EUR", "BNB/EUR"], help="Símbolos a usar en el backtest")
    ...
    parser.add_argument("--save-path", default="aprendizaje/umbral_rl.zip", help="Ruta donde guardar el modelo")
    args = parser.parse_args()

    env = make_vec_env(lambda: UmbralEnv(args.symbols, ruta_datos=args.data_dir), n_envs=1)
