...
async def test_procesar_vela_no_falla_si_metricas_explotan(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("core.vela.pipeline.CANDLES_IGNORADAS", ExplodingMetric())
    monkeypatch.setattr("core.vela.pipeline.ENTRADAS_CANDIDATAS", ExplodingMetric())
    monkeypatch.setattr("core.vela.pipeline.ENTRADAS_ABIERTAS", ExplodingMetric())
    monkeypatch.setattr("core.vela.pipeline.WARMUP_RESTANTE", ExplodingMetric())
    monkeypatch.setattr("core.vela.pipeline.LAST_BAR_AGE", ExplodingMetric())
    monkeypatch.setattr("core.vela.pipeline.HANDLER_EXCEPTIONS", ExplodingMetric())
    monkeypatch.setattr("core.vela.pipeline.EVAL_LATENCY", ExplodingHistogram())
    monkeypatch.setattr("core.vela.pipeline.PARSE_LATENCY", ExplodingHistogram())
    monkeypatch.setattr("core.vela.pipeline.GATING_LATENCY", ExplodingHistogram())
    monkeypatch.setattr("core.vela.pipeline.STRATEGY_LATENCY", ExplodingHistogram())
